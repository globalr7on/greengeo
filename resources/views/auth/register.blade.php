@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('GreenBeat')])
      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Inscrever') }}</strong></h4>
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirme sua senha...') }}" required>
              </div>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Eu concordo com a  ') }} <a href="#">{{ __('Política de Privacidade') }}</a>
              </label>
            </div>
          </div>
