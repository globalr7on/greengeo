@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Reclique')])
    ...
    <div class="col-lg-12 col-md-12 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="/register">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Nuevo Registro ') }}</p>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Estoy de acuerdo con las   ') }} <a href="#">{{ __('Politicas de privacidad') }}</a>
              </label>
            </div>
          </div>
