@extends('layouts.app', ['activePage' => 'ordem_servico', 'titlePage' => __('Ordem de Serviço')])
@section('css')
@endsection
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-left" id="tituloModal">Nova Ordem</h5>
  ...
  <script>
    $(document).ready(function () {
      $('#empresaTbl').DataTable({
        ...
        //   { width: "200px", targets: [0,1,2,3,4,5,6,7,8] },//,8,9,10,11,12,13,24,25] },
