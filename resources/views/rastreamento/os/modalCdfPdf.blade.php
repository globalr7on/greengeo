<div class="modal fade" id="modalCdfPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-left">Addicionar CDF</h5>
        ...
        <form id="formCdfPdf">
          <div class="row">
            ...
            <div class="col-md-7 align-self-center">
              <input type="file" name="pdfs" id="input_pdfs" accept="pdf/*">
            </div>
          ...
          <div class="row">
            <div class="col-md-12" id="pdfCdfPreview"></div>
          </div>
        </form>
      </div>
    </div>
