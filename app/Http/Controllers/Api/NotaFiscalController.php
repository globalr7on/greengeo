...
class NotaFiscalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($currentUser->hasRole('admin') || $request->get('all', false)) {
            $nota = NotaFiscal::all();
        } else {
    ...
    public function store(NotaFiscalRequest $request)
    {
        DB::beginTransaction();
        try {
            $nota = NotaFiscal::create($request->except('produtos_acabados'));
    ...
    public function update(NotaFiscalRequest $request, $id)
    {
        ...
        try {
            ...
            $nota->update($request->except('produtos_acabados'));
            if ($request->get('produtos_acabados')) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $notaFiscal->nota_fiscal_itens()->delete();
            $notaFiscal->delete();
            DB::commit();
        } catch (\Exception $e) {
            DB::rollBack();
